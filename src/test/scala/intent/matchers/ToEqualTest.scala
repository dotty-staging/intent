  ...
  "toEqual":
    ...
    "for Double":
      ...
      "with precision":
        ...
        "should allow customization of precision" in:
          given intent.core.FloatingPointPrecision[Double] as customPrecision:
    ...
    "for Float":
      ...
      "with precision":
        ...
        "should allow customization of precision" in:
          given intent.core.FloatingPointPrecision[Float] as customPrecision:
            def numberOfDecimals: Int = 2
    ...
    "for Option":
      ...
      "should consider custom equality" in:
        given intent.core.Eq[Int] as customIntEq:
